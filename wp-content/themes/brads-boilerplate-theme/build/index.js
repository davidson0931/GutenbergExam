...
/* harmony import */ var _scripts_useMediaQuery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/useMediaQuery */ "./src/scripts/useMediaQuery.js");
...
if (wp?.blocks?.registerBlockType !== undefined) {
  ...
  function EditComponent(props) {
    ...
    // });
    const [postId, setPostId] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
    const [heroTitle, setHeroTitle] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
    const [heroDecription, setDecription] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
    const [heroButtonTitle, setButtonTitle] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
    const [heroButtonURL, setButtonURL] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
    const [herobackImage, setBackImage] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
    const [heroPersonModelImage, setPersonModelImage] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(null);
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
      ...
      const fetchData = async () => {
        ...
        props.setAttributes({
          "heroDecription": hero_desc
        });
        props.setAttributes({
          "heroButtonTitle": hero_button_title
        });
        props.setAttributes({
          "herobackImage": hero_back_image.source_url
        });
        props.setAttributes({
          "heroButtonURL": hero_button_url
        });
        props.setAttributes({
          "heroPersonModelImage": person_model_image.source_url
        });
      };
      fetchData();
    }, [setPostId]);
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "HeroDesc",
      dangerouslySetInnerHTML: {
        __html: heroDecription
      }
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "col-6 pt-2"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap_Button__WEBPACK_IMPORTED_MODULE_8__["default"], {
      className: "btn-primary"
    }, heroButtonTitle)))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "col-5 d-flex align-items-end"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "col-12"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "row"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "heroPersonModelImage"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      src: heroPersonModelImage,
      style: {
        position: "absolute",
        left: "-78px",
        bottom: "0px",
        maxHeight: "700px" /* , height : "99vh" , minWidth :  "46vw" */
      }
    })))))))));
  }
}
...
divsToUpdate.forEach(div => {
  ...
  const root = react_dom__WEBPACK_IMPORTED_MODULE_4___default().createRoot(div);

  // root.render(<OurComponent {...data} />, div)

  root.render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(OurComponent, data));
  div.classList.remove("boilerplate-update-me");
});
function OurComponent(props) {
  const [showSkyColor, setShowSkyColor] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
  const [showGrassColor, setShowGrassColor] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
  // const [matches, setMatches] = useState(false);
  const matches640px = (0,_scripts_useMediaQuery__WEBPACK_IMPORTED_MODULE_2__.useMediaQuery)('sm');
  const FirstColClassName = classnames__WEBPACK_IMPORTED_MODULE_7___default()({
    'col-7': matches640px,
    'd-flex': matches640px,
    'col-12': !matches640px
  });
  const secondColClassName = classnames__WEBPACK_IMPORTED_MODULE_7___default()({
    'col-5': matches640px,
    'd-flex': matches640px,
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "w-100",
    style: {
      backgroundImage: `url(${props.herobackImage})`,
      height: !matches640px ? "auto" : "100vh",
      backgroundRepeat: "no-repeat"
    }
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "container"
    ...
    className: "row"
  }, matches640px, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "HeroDesc",
    dangerouslySetInnerHTML: {
      __html: props.heroDecription
    }
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "col-6 pt-2"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap_Button__WEBPACK_IMPORTED_MODULE_8__["default"], {
    className: "btn-primary"
  }, props.heroButtonTitle)))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: secondColClassName
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "col-12"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "row"
    ...
    src: props.heroPersonModelImage,
    style: {
      position: !matches640px ? "" : "absolute",
      left: "-78px",
      bottom: "0px",
      maxHeight: !matches640px ? "540px" : "700px" /* , height : "99vh" , minWidth :  "46vw" */
    }
  })))))))));
}
})();
